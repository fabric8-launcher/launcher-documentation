...
### wfswarm-rest-http-secured with admin user, debug level 2
[source,shell]
----
[sstark@rhcsb sso]$ java -jar target/sso-client.jar --app wfswarm-rest-http-secured --user admin --password admin --debug 2
Successful oc get routes: Yes
