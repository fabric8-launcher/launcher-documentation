...
endif::spring-boot-1-5[]
ifndef::spring-boot-1-5[. Include the `spring-boot-starter-actuator` and `micrometer-registry-prometheus` dependencies in your `pom.xml`.]
+
.pom.xml
