...
include::topics/assembly-updating-booster-catalog-for-local-minishift-testing.adoc[leveloffset=+2] <5>
...
modular documentation::
  An individual piece of content, called a module, is formatted in xref:writing-the-modular-way[a specific way], which allows for better reuse across guides.
