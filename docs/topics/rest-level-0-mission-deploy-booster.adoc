...
. Get your authentication token for using the `oc` CLI client with your {OpenShiftLocal} account. You can find this in the link:{link-oso-console-cli-token}[{OpenShiftLocal} Web console^].
