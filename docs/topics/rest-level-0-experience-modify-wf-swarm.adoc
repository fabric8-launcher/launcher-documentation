...
[source,options="nowrap",subs="attributes+"]
----
$ curl http://{app-name}-myproject.192.168.99.100.nip.io/supportedLanguages
["default"]
----
...
[source,options="nowrap",subs="attributes+"]
----
$ curl http://{app-name}-myproject.192.168.99.100.nip.io/default/greeting
{"content":"Hello!","node":"2311685d-aaaa-bbbb-cccc-a0e18a5b8e22"}
----
...
[source,options="nowrap",subs="attributes+"]
----
$ curl http://{app-name}-myproject.192.168.99.100.nip.io/default/greeting?name=Sarah
...
[source,options="nowrap",subs="attributes+"]
----
$ curl -H "Content-Type: application/json" -X POST -d "{\"language\":\"Spanish\",\"prefix\":\"Hola\"}" http://{app-name}-myproject.192.168.99.100.nip.io/saveWorldGreeting
----
...
[source,options="nowrap",subs="attributes+"]
----
$ curl http://{app-name}-myproject.192.168.99.100.nip.io/Spanish/greeting?name=Sarah
{"content":"Hola, Sarah!","node":"2311685d-aaaa-bbbb-cccc-a0e18a5b8e22"}
----
...
public void test_modified_service_invocation() {
  ...
  String appURL = "http://{app-name}-myproject.192.168.99.100.nip.io";
