...
* The booster created on either xref:deploying-the-{parameter-mission}-booster-to-openshiftlocal[{OpenShiftLocal}] or xref:deploying-the-{parameter-mission}-booster-to-openshiftonline[{OpenShiftOnline}].
