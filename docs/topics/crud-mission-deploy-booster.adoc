...
----
+
You `my-database` pod should have a status of `Running` once its fully deployed and started.
...
----
+
Your `{app-name}` pod should have a status of `Running` once its fully deployed and started.
