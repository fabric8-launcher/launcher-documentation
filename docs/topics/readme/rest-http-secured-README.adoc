...
You can interact with the example application using the form at the secured endpoint URL and the link:${guideURL}#rhsso-realm-model_secured[provided users].
