...
[id='interacting-with-the-unmodified-http-api-example-for-wildflyswarm_{context}']
= Interacting with the unmodified {name-example-http-api} example for {WildFlySwarm}
