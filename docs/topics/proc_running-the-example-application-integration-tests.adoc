...
//  parameter-example-name: used to display the example application name in the readable title
//
// Rationale: This procedure is highly similar for all examples except the Secured example.

[id='running-the-booster-integration-tests_{context}']
[id='running-the-example-application-integration-tests_{context}']
= Running the {parameter-example-name} example application integration tests

This example application includes a self-contained set of integration tests.
