...
= Creating {launcher} Tool Using Automated Script
...
IMPORTANT: If you are running your {OpenShiftLocal} on Windows, you must use the xref:creating-launcher-application-manually[manual method] for installing the {launcher} tool.
