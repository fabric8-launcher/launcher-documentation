...
+
For example, if you had debug logging in the xref:mission-rest-http-{context}[{name-example-http-api} booster] to log the `message` variable in the `/api/greeting` method:
+
--
