...
ifndef::built-for-spring-boot[* link:{link-mission-secured-spring-boot}[{name-example-secured} mission - {SpringBoot} booster]]

ifndef::built-for-vertx[* link:{link-mission-secured-vertx}[{name-example-secured} mission - {VertX} booster]]

ifndef::built-for-thorntail[* link:{link-mission-secured-thorntail}[{name-example-secured} mission - {Thorntail} booster]]

ifndef::built-for-nodejs[* link:{link-mission-secured-nodejs}[{name-example-secured} mission - {Node} booster]]
