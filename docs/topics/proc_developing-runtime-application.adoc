...
* See xref:selecting-the-jdk-builder-image-for-your-application_{context}[Selecting the JDK image for your application] to specify the OpenJDK image used to build your application.
