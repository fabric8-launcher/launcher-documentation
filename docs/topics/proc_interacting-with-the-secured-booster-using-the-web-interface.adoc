...
[#interacting-with-the-secured-booster-using-the-web-interface]
== Interacting with the {name-mission-secured} Booster Using the Web Interface
...
.. Click th _Login_ button and log in as xref:sso-users[the _admin_ user].
+
