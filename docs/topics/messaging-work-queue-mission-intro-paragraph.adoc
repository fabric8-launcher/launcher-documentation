...
The {name-mission-messaging-work-queue} mission showcases a messaging infrastructure built around a central broker component with multiple decoupled worker components sharing a common work queue.
