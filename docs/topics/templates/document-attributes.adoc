...
:ProductName: Red Hat Runtimes Experience
:ProductShortName: Red Hat Runtimes Experience
...
:mission-configmap-nodejs-guide-name: ConfigMap Mission - {NodeJS} Booster
...
:mission-circuit-breaker-nodejs-guide-name: Circuit Breaker Mission - {NodeJS} Booster
...
:mission-secured-nodejs-guide-name: Secured Mission - {NodeJS} Booster
...
:mission-crud-nodejs-guide-name: Relational Database Backend Mission - {NodeJS} Booster


:openshift-local-guide-name: Install and Configure a {OpenShiftLocal}
:minishift-installation-guide-name: Install and Configure the {launcher} Application
