...
:mission-cache-nodejs-guide-name: {name-mission-cache} Mission - {NodeJS} Booster
...
:SpringBootBOMVersion: 1.5.13.SP2-redhat-3
:SpringBootMvnPluginVersion: 2.0.2.RELEASE
