...
:link-launcher-openshift-local-install-guide:  https://appdev.openshift.io/docs/minishift-installation.html
...
:link-repo-docs: https://github.com/openshiftio/appdev-documentation/
