...
:mission-http-api-spring-boot-tomcat-guide-name: HTTP API Level 0 Mission - {SpringBoot}
:mission-http-api-vertx-guide-name: HTTP API Level 0 Mission - {VertX}
:mission-http-api-wf-swarm-guide-name: HTTP API Level 0 Mission - {WildFlySwarm}
...
:link-launchpad-yaml: https://raw.githubusercontent.com/openshiftio/launchpad-templates/v2/openshift/launchpad-template.yaml