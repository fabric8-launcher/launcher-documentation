...
//FIXME: define unique guide name
//:name-guide-spring-boot-1-5: {SpringBoot} 1.5 Runtime Guide
...
:version-spring-boot: 1.5.17.RELEASE
:version-spring-boot-bom: 1.5.17.SP1-redhat-00002
:version-spring-boot-maven-plugin: 1.5.17.RELEASE
