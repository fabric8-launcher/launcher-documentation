...
:SpringBootBOMVersion: 1.5.15.Final-redhat-00002
:SpringBootMvnPluginVersion: 1.5.15.RELEASE
...
:link-spring-boot-guide: https://launcher.fabric8.io/docs/spring-boot-runtime.html
