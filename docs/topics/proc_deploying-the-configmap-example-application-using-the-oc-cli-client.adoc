...
[id='deploying-the-configmap-example-application-using-the-oc-cli-client_{context}']
= Deploying the {name-example-configmap} example application using the `oc` CLI client
