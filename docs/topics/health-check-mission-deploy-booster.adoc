...
{app-name}   {app-name}-myproject.192.168.64.3.nip.io             {app-name}   8080                    None
----
+
A pod's route information gives you the base URL which you use to access it. In the example above, you would use `http://{app-name}-myproject.192.168.64.3.nip.io ` as the base URL to access the applications.
