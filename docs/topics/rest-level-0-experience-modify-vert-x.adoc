...
[source,options="nowrap",subs="attributes+"]
----
$ curl http://{app-name}-myproject.192.168.99.100.nip.io/api/supportedLanguages
[ "default" ]
----
...
[source,options="nowrap",subs="attributes+"]
----
$ curl http://{app-name}-myproject.192.168.99.100.nip.io/api/default/greeting
{
  "content" : "Hello!"
}
----
...
[source,options="nowrap",subs="attributes+"]
----
$ curl http://{app-name}-myproject.192.168.99.100.nip.io/api/default/greeting?name=Sarah
{
  "content" : "Hello, Sarah!"
}
----
...
[source,options="nowrap",subs="attributes+"]
----
$ curl -H "Content-Type: application/json" -X POST -d "{\"language\":\"Spanish\",\"prefix\":\"Hola\"}" http://{app-name}-myproject.192.168.99.100.nip.io/api/saveWorldGreeting
----
...
[source,options="nowrap",subs="attributes+"]
----
$ curl http://{app-name}-myproject.192.168.99.100.nip.io/api/Spanish/greeting?name=Sarah
{
  "content" : "Hola, Sarah!"
}
----
