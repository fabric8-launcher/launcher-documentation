...
IMPORTANT: Before proceeding, make sure you have granted *launch.openshift.io* access to GitHub and OpenShift; this one-time step can be done http://sso.openshift.io/auth/realms/rh-developers-launch/account/identity[here, window="_blank"].
