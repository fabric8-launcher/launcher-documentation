...
You can complete this one-time setup procedure in your http://sso.openshift.io/auth/realms/rh-developers-launch/account/identity[{RHSSO} federated identity settings^].
--
