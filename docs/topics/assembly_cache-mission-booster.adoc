...
= {name-example-cache} mission - {runtime} booster
...
The {name-example-cache} mission demonstrates how to use a cache to increase the response time of applications.
