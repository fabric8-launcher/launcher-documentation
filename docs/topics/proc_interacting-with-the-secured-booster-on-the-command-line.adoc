...
* The secured booster endpoint URL. For more information, see xref:getting-the-secured-booster-api-endpoint[].
...
For more information, see xref:getting-the-secured-booster-api-endpoint[].
--
