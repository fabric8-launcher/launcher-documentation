...
= Starting and Configuring the {OpenShiftLocal} for the {launcher} Service

This chapter contains instructions for starting the {OpenShiftLocal} and configuring it to execute the {launcher} service.
