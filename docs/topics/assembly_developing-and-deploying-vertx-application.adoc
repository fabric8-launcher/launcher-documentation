...
In addition to xref:mission-rest-http-vertx[using a booster], you can create new {VertX} applications from scratch and deploy them to OpenShift or standalone Red{nbsp}Hat Enterprise Linux.
...
include::proc_developing-an-application.adoc[leveloffset=+1]

//Preparing and deploying application tp OpenShift
include::assembly_deploying-an-application-to-openshift.adoc[leveloffset=+1]
...
include::assembly_deploying-an-application-to-standalone-rhel.adoc[leveloffset=+1]
