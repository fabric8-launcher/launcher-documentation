...
In addition to xref:example-rest-http-vertx[using an example], you can create a new {VertX} application from scratch and deploy it to OpenShift or standalone Red{nbsp}Hat Enterprise Linux.
