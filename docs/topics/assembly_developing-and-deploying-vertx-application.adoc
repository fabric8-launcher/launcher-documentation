...
In addition to xref:example-rest-http-vertx[using an example], you can create new {VertX} applications from scratch and deploy them to OpenShift or standalone Red{nbsp}Hat Enterprise Linux.
...
//Selecting the image to build and deploy your application
include::proc_selecting-the-jdk-builder-image-for-your-application.adoc[leveloffset=+1]
