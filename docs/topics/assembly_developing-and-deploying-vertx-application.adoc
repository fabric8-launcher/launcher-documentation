...
In addition to xref:mission-rest-http-vertx[using an example], you can create new {VertX} applications from scratch and deploy them to OpenShift or standalone Red{nbsp}Hat Enterprise Linux.
