...
link:{https://www.openshift.com/products/container-platform/}[{OpenShiftContainerPlatform}]:: A private, on-premise cloud by Red Hat.

link:{https://www.openshift.com/products/online/}[{OpenShiftOnline}]:: A public cloud hosted by Red Hat.
