[id='interacting-with-the-unmodified-http-api-booster-for-vertx_{context}']
[id='interacting-with-the-unmodified-http-api-example-application-for-vertx_{context}']
= Interacting with the unmodified {name-example-http-api} example application for {VertX}
