...
[id='deploying-an-application-to-standalone-rhel8_{context}']
= Deploying an application to standalone Red Hat Enterprise Linux 8

Deploy your {parameter-runtime-name} application to Red Hat Enterprise Linux 8.
