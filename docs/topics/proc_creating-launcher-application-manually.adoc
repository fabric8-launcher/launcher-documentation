...
ifndef::parameter-custom-catalog[= Creating {launcher} Tool Manually]
ifdef::parameter-custom-catalog[= Creating {launcher} Tool]

Create a local customized instance of the {launcher} tool, which allows you to test the functionality or make modifications to the service using a web interface.
