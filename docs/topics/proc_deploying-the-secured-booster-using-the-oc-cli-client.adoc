...
These commands install any missing package dependencies, then using the xref:about-nodeshift[Nodeshift] package, launch the link:{link-s2i-process}[S2I process] on {parameter-deployment} to start the pod.
--
endif::secured-nodejs-mission[]
