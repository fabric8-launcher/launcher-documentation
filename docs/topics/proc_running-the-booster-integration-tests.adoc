...
[id='running-the-example-integration-tests_{context}']
= Running the {parameter-example-name} example integration tests

This example includes a self-contained set of integration tests.
