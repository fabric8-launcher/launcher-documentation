...
ifndef::built-for-spring-boot[* link:{link-mission-crud-spring-boot}[{name-example-crud} mission - {SpringBoot} booster]]

ifndef::built-for-vertx[* link:{link-mission-crud-vertx}[{name-example-crud} mission - {VertX} booster]]

ifndef::built-for-thorntail[* link:{link-mission-crud-thorntail}[{name-example-crud} mission - {Thorntail} booster]]

ifndef::built-for-nodejs[* link:{link-mission-crud-nodejs}[{name-example-crud} mission - {Node} booster]]
