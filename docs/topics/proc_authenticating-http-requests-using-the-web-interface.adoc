...
+
--
.Unauthenticated {name-example-secured} Booster Web Interface
image::sso-main.png[]
...
.Authenticated {name-example-secured} Booster Web Interface (as Alice)
image::sso-alice.png[]
--
...
+
.Authenticated {name-example-secured} Booster Web Interface (as admin)
image::sso-admin.png[]
