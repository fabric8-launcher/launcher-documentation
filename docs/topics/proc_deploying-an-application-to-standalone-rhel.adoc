...
ifdef::built-for-thorntail[You can use the Thorntail Maven Plugin to package you application as an link:{link-guide-thorntail}#creating-an-uberjar_wf-swarm[_uberjar_].]
