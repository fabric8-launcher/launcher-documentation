...
For more information on setting up integration tests for your application, see the section on link:http://vertx.io/blog/unit-and-integration-tests/[unit and integration testing with Vert.x].
When developing a REST API for your application, follow the section link:http://vertx.io/blog/some-rest-with-vert-x/[developing a REST API with Vert.x].
