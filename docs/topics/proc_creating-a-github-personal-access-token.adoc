...
To install the {name-launcher} tool on a {OpenShiftLocal}, you must provide the {name-launcher} tool with a GitHub personal access token. This enables the {name-launcher} tool to create example applications and save them as Git repositories in your GitHub namespace.
