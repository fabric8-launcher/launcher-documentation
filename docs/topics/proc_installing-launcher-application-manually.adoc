...
[#installing-launcher-application-manually]
ifndef::parameter-custom-catalog[= Installing {launcher} Tool Manually]
ifdef::parameter-custom-catalog[= Installing {launcher} Tool]
