...
= Deploying the {parameter-example-name} example to {OpenShiftOnline}

:parent-context: {context}
:context: {parent-context}-oso

Use one of the following options to execute the {parameter-example-name} example on {OpenShiftOnline}.
