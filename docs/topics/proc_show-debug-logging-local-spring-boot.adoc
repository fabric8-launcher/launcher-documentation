...
To disable debug logging, remove `logging.level.fully.qualified.name.of.TheClass=DEBUG` from `src/resources/application.properties` and restart your application.