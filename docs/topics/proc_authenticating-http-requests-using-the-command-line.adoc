...
* The secured example endpoint URL. For more information, see xref:getting-the-secured-example-api-endpoint_{context}[].
...
For more information, see xref:getting-the-secured-example-api-endpoint_{context}[].
--
