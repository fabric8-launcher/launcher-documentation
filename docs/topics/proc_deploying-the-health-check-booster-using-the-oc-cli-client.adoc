...
[id='deploying-the-health-check-example-application-using-the-oc-client_{context}']
= Deploying the {name-example-health-check} example application using the `oc` CLI client
...
. Once your application is deployed and started, determine its route.
+
