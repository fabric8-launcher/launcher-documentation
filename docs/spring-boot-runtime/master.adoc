...
[IMPORTANT]
--
This guide applies to {SpringBoot} {version-spring-boot}.
For releases based on {SpringBoot} 1.5.x, follow the link:{link-guide-spring-boot-1-5}[{SpringBoot} 1.5.x Runtime Developer Guide].
--
