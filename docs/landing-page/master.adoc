...
<div class="jumbotron">
  <div class="container">
    ...
    <p class="lead">
      Read how to get started and setup your environment and all the good stuff that you can do with Fabric8 Launcher.
    </p>
    <p>
...
<section id="runtimes">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h3>Documentation on the Supported Runtimes</h3>
      </div>
    </div>
    <div class="row">
      <div class="col-sm-3 runtime">
        ...
        <p>
          Learn how to use launcher for Wildfly swarm projects
        </p>
        <a href="/docs/wf-swarm-runtime.html" class="btn btn-default" role="button">
          Learn more
        </a>
      </div>
      ...
      <div class="col-sm-3 runtime">
        ...
        <p >
          Learn how to use launcher for Eclipse Vert.x projects
        </p>
      ...
      <div class="col-sm-3 runtime">
        ...
        <p >
          Learn how to use launcher for Spring boot projects
        </p>
      ...
      <div class="col-sm-3 runtime">
        ...
        <p >
            Learn how to use launcher for Node.js® projects
        </p>
