...
<section id="intro">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4">
        <a class="btn btn-lg" href="getting-started.html">Get Started Now</a>
      </div>
    </div>
  </div>
</section>
