...
//Following topics are from the Getting Started With Red Hat OpenShift Application Runtimes guide
include::topics/con_supported-build-strategies-for-openshift-deployment.adoc[leveloffset=+1]
