...
ifdef::product[]
include::topics/wildfly-swarm/docs/reference/index-product.adoc[leveloffset=+2]
endif::[]
ifndef::product[]
include::topics/wildfly-swarm/docs/reference/index-community.adoc[leveloffset=+2]
endif::[]
