...
include::topics/wildfly-swarm/docs/howto/autodetect-fractions/index.adoc[leveloffset=+2]
include::topics/wildfly-swarm/docs/howto/explicit-fractions/index.adoc[leveloffset=+2]
...
include::topics/proc_secured-mission-running-integration-tests.adoc[leveloffset=+3]
