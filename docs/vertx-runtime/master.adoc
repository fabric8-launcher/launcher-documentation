...
This sections contains information about creating {VertX} applications and deploying them to OpenShift or Red Hat Enterprise Linux. 
...
:parameter-runtime-name: {VertX}
include::topics/proc_deploying-an-application-to-standalone-rhel.adoc[leveloffset=+2]
:parameter-runtime-name!:
