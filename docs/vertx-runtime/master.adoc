...
This sections contains information about creating and configuring {VertX} applications and deploying them to OpenShift or Red Hat Enterprise Linux. 
...
:parameter-runtime-name: {VertX}
include::topics/assembly_deploying-a-rhoar-application-on-openshift.adoc[leveloffset=+2]
:parameter-runtime-name!:

:parameter-runtime-name: {VertX}
include::topics/proc_deploying-application-to-standalone-rhel.adoc[leveloffset=+2]
:parameter-runtime-name!:
