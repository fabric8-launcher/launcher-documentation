...
Basic information about publishing a release is described in the link:https://launcher.fabric8.io/docs/contrib-guide.html#releasing-new-version_contributing[Releasing New Version] chapter of the __Contribution Guide.__
