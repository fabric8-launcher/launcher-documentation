...
Generated docs are built and deployed on every commit to the authoritative repository (https://github.com/openshiftio/appdev-documentation[upstream/master]) and are available at http://appdev.openshift.io/docs/[http://appdev.openshift.io/docs].
