...
Generated docs are built and deployed on every commit to the authoritative repository (https://github.com/openshiftio/appdev-documentation[upstream/master]) and are available, for the time being, at http://openshiftio-appdev-docs-appdev-documentation.tsrv.devshift.net/[http://openshiftio-appdev-docs-appdev-documentation.tsrv.devshift.net/].
